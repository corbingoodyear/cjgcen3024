...
template <class NODETYPE>
List<NODETYPE>::List(const List& obj)
{
    if (obj.firstPtr == 0) {
        firstPtr = lastPtr = 0;
    }
        ...
        firstPtr = lastPtr = 0;
        ListNode<NODETYPE>* currentPtr = obj.firstPtr;
        while (currentPtr != 0) {
...
template <class NODETYPE>
List<NODETYPE>& List<NODETYPE>::operator=(const List& obj)
{
    if (&obj == this) {
        return *this;
    }
        ...
        if (firstPtr == lastPtr && index == 1) {
            ...
            if (index >= count || index <= 0) {
                ...
                if (count == index) {
                    ...
                    currPtr->nextPtr = currentPtr->nextPtr;
                    value = tempPtr->data;
                    delete tempPtr;
                    return true;
                } // end else
